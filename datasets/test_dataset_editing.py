...
class Dataset_Ref_Editing(torch.utils.data.Dataset):
    def __init__(self,
...
class ImageFolderTestset_Editing(Dataset_Ref_Editing):
    def __init__(self,
        ...
        **super_kwargs,         # Additional arguments for the Dataset base class.
        ...
        self.items = [item for item in self._image_fnames if 'input' in item]
    ...
    def __getitem__(self, idx):
        ...
        ref_image_path = os.path.join('ref', image_name)
        ...
        idx = np.array(idx)
        return_list = [idx, image_path, input_tensor, ref_tensor, ref_tensor_mae, input_np, ref_np]
        return return_list