...
class TrainOptions:
	...
	def initialize(self):
		self.parser.add_argument('--job_name', default='test', type=str)
		self.parser.add_argument('--model_cache_dir', default='./pretrained_models', type=str)
		self.parser.add_argument('--train_data_path', default='./train', type=str)
		self.parser.add_argument('--train_epoch', default=100, type=int)
		self.parser.add_argument('--val_data_path', default='./test', type=str)
		self.parser.add_argument('--exp_dir', default='./exps', type=str, help='Path to experiment output directory')
		self.parser.add_argument('--image_log_path', default='./exps/', type=str, help='Path to output test images')
		self.parser.add_argument('--device', default='cuda:0,1', type=str, help='CUDA device to train the model on')
		self.parser.add_argument('--batch_size', default=4, type=int, help='Batch size for training')
		self.parser.add_argument('--val_batch_size', default=3, type=int, help='Batch size for validation')
		...
		self.parser.add_argument('--learning_rate_encoder', default=0.00005, type=float, help='Optimizer learning rate for encoder')
		...
		self.parser.add_argument('--tri_lambda', default=1.0, type=float, help='Triplanar loss multiplier factor')
		self.parser.add_argument('--depth_lambda', default=0.5, type=float, help='Depth loss multiplier factor')
		self.parser.add_argument('--feature_lambda', default=0.0, type=float, help='Feature loss multiplier factor')
		...
		self.parser.add_argument('--image_interval', default=300, type=int, help='Interval for logging train images during training')
		...
		self.parser.add_argument('--resume_path', default='./pretrained_models/encoder_render_LT_90000.pt', type=str, help='Path to .pt checkpoint to resume training')
