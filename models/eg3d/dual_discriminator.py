...
from models.eg3d.networks_stylegan2 import DiscriminatorBlock, MappingNetwork, DiscriminatorEpilogue
...
@persistence.persistent_class
class DualDiscriminator_Editing(torch.nn.Module):
    def __init__(self,
        c_dim,                          # Conditioning label (C) dimensionality.
        img_resolution,                 # Input resolution.
        img_channels,                   # Number of input color channels.
    ...
    def forward(self, img, c, update_emas=False, **block_kwargs):
        img = torch.cat([img['image'], img['image_ref']], 1)
